...
<body>
    ...
    id='sidebar'>
        ...
        <div style='width:100%;height:50px;' class='d-flex align-items-center justify-content-center bg-light'>
            ...
            <a href="PagInicio.php" class='text-dark text-decoration-none'>Agenda
            </a>
        </div>
        ...
        <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor" class="bi bi-people-fill" viewBox="0 0 16 16">
            ...
            <a href="usuarios.php" class='text-light text-decoration-none'>Usuarios
            </a>
        </div>
    </nav>
