...
$test = new Turno();
// $prueba = $test->insertarCita('carlos','Sprint Review','24/03/22');
...
<body>
    ...
    id='sidebar'>
        ...
        <div style='width:60%;height:50px;' class='d-flex align-items-center justify-content-around'>
        ...
        <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor" class="bi bi-people-fill" viewBox="0 0 16 16">
            ...
            <a href="usuarios.php" class='text-light text-decoration-none'>
                <p>Usuarios</p>
            </a>
        </div>
    </nav>
